# HackerNews-email-automation using python [freecodecamp]
...
Less secure app access from their google account 
https://myaccount.google.com/security
 
@@ the program will throw an error if you enter the wrong password/username @@
